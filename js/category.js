...
import { scrollTop,verifyHeart,categoryHeartNotColored,categoryHeartColored,baglaUyariyi,handleMiqdar,handleSebet } from "../utilities/index.js";
                        ...
                        <div class="flex flex-col gap-[10px] items-center mb-[20px] mt-auto">
                            ...
                            <div class="flex items-center justify-center flex-wrap gap-[10px]">
                                <button onclick="sebeteAt(${item.id},this.parentElement.previousElementSibling.querySelector('div').querySelector('input').value)"  
                                    onmouseenter="this.querySelector('div').style.opacity='1'" onmouseleave="this.querySelector('div').style.opacity='0'" class="relative cursor-pointer text-white hover:bg-[#de7200] bg-or px-[21px] h-[31px] rounded-[15px] transition-all duration-200 ease-in font-[600] text-[12px] text-nowrap">
                                    <span>Səbətə at</span>
